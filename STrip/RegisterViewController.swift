...
class RegisterViewController: UIViewController {
    ...
    func getCode(phoneNumber: String) {
        ...
        Alamofire.request(ConstValue.address + "/Trip5.0/user/getRegisterCode", method: .post, parameters:parameters)
    ...
    func register(phoneNumber: String, code: String, passWord:String) {
        ...
        Alamofire.request(ConstValue.address + "/Trip5.0/userRegister?", method: .post, parameters:parameters)
            .responseJSON(completionHandler:{ Response in
